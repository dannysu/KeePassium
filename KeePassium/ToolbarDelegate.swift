...
extension NSToolbarItem.Identifier {
    static let openDatabase = NSToolbarItem.Identifier("com.dannysu.keepassium.toolbar.openDatabase")
    static let lockDatabase = NSToolbarItem.Identifier("com.dannysu.keepassium.toolbar.lockDatabase")
    static let newEntry = NSToolbarItem.Identifier("com.dannysu.keepassium.toolbar.newEntry")
    static let newGroup = NSToolbarItem.Identifier("com.dannysu.keepassium.toolbar.newGroup")
    static let newSmartGroup = NSToolbarItem.Identifier("com.dannysu.keepassium.toolbar.newSmartGroup")
    static let autoType = NSToolbarItem.Identifier("com.dannysu.keepassium.toolbar.autoType")
    static let randomGenerator = NSToolbarItem.Identifier("com.dannysu.keepassium.toolbar.randomGenerator")
    static let settings = NSToolbarItem.Identifier("com.dannysu.keepassium.toolbar.settings")
}
#endif
